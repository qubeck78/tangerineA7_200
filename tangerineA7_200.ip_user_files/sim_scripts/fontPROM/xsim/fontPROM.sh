...
#
# Script generated by Vivado on Wed Aug 21 12:06:26 +0200 2024
...
# script info
echo -e "fontPROM.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fontPROM xil_defaultlib.fontPROM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fontPROM -key {Behavioral:sim_1:Functional:fontPROM} -tclbatch cmd.tcl -log simulate.log
}
