...
#
# Script generated by Vivado on Sat Aug 17 21:46:36 +0200 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : keyboardFifo.sh
...
#
# Usage        : keyboardFifo.sh
#                keyboardFifo.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                keyboardFifo.sh [-reset_run]
#                keyboardFifo.sh [-reset_log]
#                keyboardFifo.sh [-help]
#
...
# script info
echo -e "keyboardFifo.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./keyboardFifo.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_9 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot keyboardFifo xil_defaultlib.keyboardFifo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim keyboardFifo -key {Behavioral:sim_1:Functional:keyboardFifo} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb keyboardFifo.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./keyboardFifo.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: keyboardFifo.sh [-help]\n\
Usage: keyboardFifo.sh [-step]\n\
Usage: keyboardFifo.sh [-lib_map_path]\n\
Usage: keyboardFifo.sh [-reset_run]\n\
Usage: keyboardFifo.sh [-reset_log]\n\
Usage: keyboardFifo.sh [-keep_index]\n\
Usage: keyboardFifo.sh [-noclean_files]\n\n\
