...
#
# Script generated by Vivado on Sat Dec 28 09:51:14 +0100 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fpAddSub.sh
...
#
# Usage        : fpAddSub.sh
#                fpAddSub.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fpAddSub.sh [-reset_run]
#                fpAddSub.sh [-reset_log]
#                fpAddSub.sh [-help]
#
...
#                script (type 'fpAddSub.sh -help' for more information).
#
...
# script info
echo -e "fpAddSub.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fpAddSub.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fpAddSub xil_defaultlib.glbl -o fpAddSub_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fpAddSub_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fpAddSub_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fpAddSub_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fpAddSub.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fpAddSub.sh [-help]\n\
Usage: fpAddSub.sh [-step]\n\
Usage: fpAddSub.sh [-lib_map_path]\n\
Usage: fpAddSub.sh [-reset_run]\n\
Usage: fpAddSub.sh [-reset_log]\n\
Usage: fpAddSub.sh [-keep_index]\n\
Usage: fpAddSub.sh [-noclean_files]\n\n\
