...
#
# Script generated by Vivado on Tue Oct 08 07:45:30 +0200 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : gfxPaletteRam.sh
...
#
# Usage        : gfxPaletteRam.sh
#                gfxPaletteRam.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                gfxPaletteRam.sh [-reset_run]
#                gfxPaletteRam.sh [-reset_log]
#                gfxPaletteRam.sh [-help]
#
...
#                script (type 'gfxPaletteRam.sh -help' for more information).
#
...
# script info
echo -e "gfxPaletteRam.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./gfxPaletteRam.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.gfxPaletteRam xil_defaultlib.glbl -o gfxPaletteRam_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./gfxPaletteRam_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key gfxPaletteRam_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc gfxPaletteRam_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./gfxPaletteRam.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: gfxPaletteRam.sh [-help]\n\
Usage: gfxPaletteRam.sh [-step]\n\
Usage: gfxPaletteRam.sh [-lib_map_path]\n\
Usage: gfxPaletteRam.sh [-reset_run]\n\
Usage: gfxPaletteRam.sh [-reset_log]\n\
Usage: gfxPaletteRam.sh [-keep_index]\n\
Usage: gfxPaletteRam.sh [-noclean_files]\n\n\
