...
#
# Script generated by Vivado on Sat Dec 28 10:36:28 +0100 2024
...
#
# Usage        : fpDiv.sh
#                fpDiv.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fpDiv.sh [-reset_run]
#                fpDiv.sh [-reset_log]
#                fpDiv.sh [-help]
#
...
#                script (type 'fpDiv.sh -help' for more information).
#
...
# script info
echo -e "fpDiv.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fpDiv.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fpDiv xil_defaultlib.glbl -o fpDiv_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fpDiv_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fpDiv_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fpDiv_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fpDiv.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fpDiv.sh [-help]\n\
Usage: fpDiv.sh [-step]\n\
Usage: fpDiv.sh [-lib_map_path]\n\
Usage: fpDiv.sh [-reset_run]\n\
Usage: fpDiv.sh [-reset_log]\n\
Usage: fpDiv.sh [-keep_index]\n\
Usage: fpDiv.sh [-noclean_files]\n\n\
