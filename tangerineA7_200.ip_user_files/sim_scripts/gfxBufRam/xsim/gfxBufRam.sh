...
#
# Script generated by Vivado on Wed Aug 14 16:08:28 +0200 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : gfxBufRam.sh
...
#
# Usage        : gfxBufRam.sh
#                gfxBufRam.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                gfxBufRam.sh [-reset_run]
#                gfxBufRam.sh [-reset_log]
#                gfxBufRam.sh [-help]
#
...
# script info
echo -e "gfxBufRam.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./gfxBufRam.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot gfxBufRam xil_defaultlib.gfxBufRam xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim gfxBufRam -key {Behavioral:sim_1:Functional:gfxBufRam} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb gfxBufRam.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./gfxBufRam.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: gfxBufRam.sh [-help]\n\
Usage: gfxBufRam.sh [-step]\n\
Usage: gfxBufRam.sh [-lib_map_path]\n\
Usage: gfxBufRam.sh [-reset_run]\n\
Usage: gfxBufRam.sh [-reset_log]\n\
Usage: gfxBufRam.sh [-keep_index]\n\
Usage: gfxBufRam.sh [-noclean_files]\n\n\
