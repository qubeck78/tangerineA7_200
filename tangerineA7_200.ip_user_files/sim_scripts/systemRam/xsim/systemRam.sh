...
#
# Script generated by Vivado on Mon Nov 11 15:42:38 +0100 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : systemRam.sh
...
#
# Usage        : systemRam.sh
#                systemRam.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                systemRam.sh [-reset_run]
#                systemRam.sh [-reset_log]
#                systemRam.sh [-help]
#
...
# script info
echo -e "systemRam.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./systemRam.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot systemRam xil_defaultlib.systemRam xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim systemRam -key {Behavioral:sim_1:Functional:systemRam} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb systemRam.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./systemRam.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: systemRam.sh [-help]\n\
Usage: systemRam.sh [-step]\n\
Usage: systemRam.sh [-lib_map_path]\n\
Usage: systemRam.sh [-reset_run]\n\
Usage: systemRam.sh [-reset_log]\n\
Usage: systemRam.sh [-keep_index]\n\
Usage: systemRam.sh [-noclean_files]\n\n\
