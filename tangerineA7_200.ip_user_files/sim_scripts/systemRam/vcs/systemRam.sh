...
#                script (type 'systemRam.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.systemRam xil_defaultlib.glbl -o systemRam_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./systemRam_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key systemRam_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc systemRam_simv.daidir vcs_lib c.obj)
