...
#
# Script generated by Vivado on Sat Dec 28 10:17:22 +0100 2024
...
#
# Usage        : fpMul.sh
#                fpMul.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fpMul.sh [-reset_run]
#                fpMul.sh [-reset_log]
#                fpMul.sh [-help]
#
...
#                script (type 'fpMul.sh -help' for more information).
#
...
# script info
echo -e "fpMul.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fpMul.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fpMul xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fpMul -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fpMul_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: fpMul.sh [-reset_log]\n\
Usage: fpMul.sh [-keep_index]\n\
