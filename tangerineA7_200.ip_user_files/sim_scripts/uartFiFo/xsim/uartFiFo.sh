...
#
# Script generated by Vivado on Tue Aug 06 12:20:36 +0200 2024
...
#
# Usage        : uartFiFo.sh
#                uartFiFo.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                uartFiFo.sh [-reset_run]
#                uartFiFo.sh [-reset_log]
#                uartFiFo.sh [-help]
#
...
# script info
echo -e "uartFiFo.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./uartFiFo.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_9 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot uartFiFo xil_defaultlib.uartFiFo xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb uartFiFo.wdb xsim.dir libdpi.so)
...
Usage: uartFiFo.sh [-step]\n\
Usage: uartFiFo.sh [-lib_map_path]\n\
Usage: uartFiFo.sh [-reset_run]\n\
Usage: uartFiFo.sh [-reset_log]\n\
Usage: uartFiFo.sh [-keep_index]\n\
