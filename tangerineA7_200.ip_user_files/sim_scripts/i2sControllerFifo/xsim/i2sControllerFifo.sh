...
#
# Script generated by Vivado on Wed Sep 25 14:22:21 +0200 2024
...
# script info
echo -e "i2sControllerFifo.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_9 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot i2sControllerFifo xil_defaultlib.i2sControllerFifo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim i2sControllerFifo -key {Behavioral:sim_1:Functional:i2sControllerFifo} -tclbatch cmd.tcl -log simulate.log
}
