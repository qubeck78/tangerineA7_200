...
MP3DecInfo			staticMP3DecInfo;
FrameHeader			staticFrameHeader;
SideInfo				staticSideInfo;
ScaleFactorInfo	staticScaleFactorInfo;
HuffmanInfo			staticHuffmanInfo;
DequantInfo			staticDequantInfo;
IMDCTInfo			staticIMDCTInfo;
SubbandInfo			staticSubbandInfo;
...
MP3DecInfo *AllocateBuffers(void)
{
	...
	mp3DecInfo = (MP3DecInfo *)&staticMP3DecInfo; //malloc(sizeof(MP3DecInfo));
	if (!mp3DecInfo)
		return 0;
	ClearBuffer(mp3DecInfo, sizeof(MP3DecInfo));
	
	fh =  (FrameHeader *)&staticFrameHeader;	//     malloc(sizeof(FrameHeader));
	si =  (SideInfo *)&staticSideInfo;	//        malloc(sizeof(SideInfo));
	sfi = (ScaleFactorInfo *)&staticScaleFactorInfo;	// malloc(sizeof(ScaleFactorInfo));
	hi =  (HuffmanInfo *)&staticHuffmanInfo;	//     malloc(sizeof(HuffmanInfo));
	di =  (DequantInfo *)&staticDequantInfo;	//     malloc(sizeof(DequantInfo));
	mi =  (IMDCTInfo *)&staticIMDCTInfo;	//       malloc(sizeof(IMDCTInfo));
	sbi = (SubbandInfo *)&staticSubbandInfo;	//     malloc(sizeof(SubbandInfo));
